...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const shippedItems = document.getElementById("shipped-items");
    ...
    addButtons.forEach(button => {
        button.addEventListener("click", () => {
            const productContainer = button.parentElement.cloneNode(true);
            const removeButton = document.createElement("button");
            removeButton.textContent = "Remove";
            removeButton.classList.add("remove-button");

            // Eliminar el botón "Add" del contenedor clonado
            productContainer.querySelector(".add-button").remove();

            // Agregar el botón "Remove" al contenedor clonado
            productContainer.appendChild(removeButton);
            
            shippedItems.appendChild(productContainer);
